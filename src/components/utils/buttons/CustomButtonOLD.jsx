...
const variants = {
  primary: {
    filled: "bg-blue-500 hover:bg-blue-400 focus:ring-blue-300 text-white",
    outline:
      "text-blue-500 border-[1px] border-blue-500 hover:bg-blue-500 hover:text-white focus:ring-blue-500",
    tag: "text-black text-sm bg-blue-500/10 hover:bg-blue-900/20 active:bg-blue-900/30 rounded-xl transition-all select-none disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none",
  },
  secondary: {
